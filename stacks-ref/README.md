...
Script 01 creates a population map. 
I first ran the pipeline for each alpha threshold using all samples (scripts 02 and 03).
I then made the decision to filter to remove samples with read depth <5X, and I re-ran the pipeline for both alphas (script 04).
